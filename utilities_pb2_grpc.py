...
class UtilityServicesStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTodaysActivityBook = channel.unary_unary(
                '/UtilityServices/GetTodaysActivityBook',
                request_serializer=utilities__pb2.TodaysActivityBookRequest.SerializeToString,
                response_deserializer=utilities__pb2.TodaysActivityBookResponse.FromString,
                )
...
class UtilityServicesServicer(object):
    ...
    def GetTodaysActivityBook(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UtilityServicesServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetTodaysActivityBook': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTodaysActivityBook,
                    request_deserializer=utilities__pb2.TodaysActivityBookRequest.FromString,
                    response_serializer=utilities__pb2.TodaysActivityBookResponse.SerializeToString,
            ),
...
class UtilityServices(object):
    ...
    @staticmethod
    def GetTodaysActivityBook(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/UtilityServices/GetTodaysActivityBook',
            utilities__pb2.TodaysActivityBookRequest.SerializeToString,
            utilities__pb2.TodaysActivityBookResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
