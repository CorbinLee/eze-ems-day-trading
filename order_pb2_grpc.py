...
class SubmitOrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetOrderDetailByOrderIdJson = channel.unary_unary(
                '/SubmitOrderService/GetOrderDetailByOrderIdJson',
                request_serializer=order__pb2.OrderDetailByOrderIdJsonRequest.SerializeToString,
                response_deserializer=order__pb2.OrderDetailByOrderIdJsonResponse.FromString,
                )
        self.GetOrderDetailByDateRangeJson = channel.unary_stream(
                '/SubmitOrderService/GetOrderDetailByDateRangeJson',
...
class SubmitOrderServiceServicer(object):
    ...
    def GetOrderDetailByOrderIdJson(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def GetOrderDetailByDateRangeJson(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SubmitOrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetOrderDetailByOrderIdJson': grpc.unary_unary_rpc_method_handler(
                    servicer.GetOrderDetailByOrderIdJson,
                    request_deserializer=order__pb2.OrderDetailByOrderIdJsonRequest.FromString,
                    response_serializer=order__pb2.OrderDetailByOrderIdJsonResponse.SerializeToString,
            ),
            'GetOrderDetailByDateRangeJson': grpc.unary_stream_rpc_method_handler(
...
class SubmitOrderService(object):
    ...
    @staticmethod
    def GetOrderDetailByOrderIdJson(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/SubmitOrderService/GetOrderDetailByOrderIdJson',
            order__pb2.OrderDetailByOrderIdJsonRequest.SerializeToString,
            order__pb2.OrderDetailByOrderIdJsonResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def GetOrderDetailByDateRangeJson(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
